...
final class MediaPlayer : UIView {
    ...
    private lazy var nextButton: UIButton = {
        ...
        v.addTarget(self, action: #selector(didTapPlayNext(_:)), for: .touchUpInside)
        v.tintColor = .white
    ...
    private func setUpView() {
        ...
        setupPlayer(song: album.song[playingIndex])
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            remainingTimeLabel.trailingAnchor.constraint(equalTo: trailingAnchor,constant: -5),
            remainingTimeLabel.topAnchor.constraint(equalTo:progressBar.bottomAnchor,constant: 8),
           
        ])
        
        //control stack constaints
        
        NSLayoutConstraint.activate([
            controlStack.leadingAnchor.constraint(equalTo: leadingAnchor,constant: 32),
            controlStack.trailingAnchor.constraint(equalTo: trailingAnchor,constant: -22),
    ...
    func play(){
        ...
        player.play()
        setPlayPause(isPlaying: player.isPlaying)
    }
    ...
    private func setPlayPause(isPlaying:Bool){
    ...
    //MARK: Track audio update progress
    ...
    @objc private func didTapPrevious(_ sender: UIButton){
        ...
        if playingIndex < 0 {
            ...
            playingIndex = album.song.count - 1
        }
    ...
    @objc private func didTapPlayNext(_ sender: UIButton){
        
        playingIndex += 1
        
        if playingIndex >= album.song.count  {
