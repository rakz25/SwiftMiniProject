    ...
    var album: Album? {
        didSet {
            if let album = album {
                ...
                songsCount.text = "\(album.song.count) songs"
            }
        }
    }
...
//    private lazy var alName: UILabel =  {
//        let v = UILabel()
//        v.translatesAutoresizingMaskIntoConstraints = false
//        v.font = UIFont.systemFont(ofSize: 18, weight: .bold)
//        v.textColor = UIColor(named: "titleColor")
...
//    }()
    ...
    //use when xib cell used from storyboard
    ...
    private func setUpConstraints(){
        ...
        NSLayoutConstraint.activate([
            ...
            albumName.trailingAnchor.constraint(equalTo: contentView.trailingAnchor)
            ])
